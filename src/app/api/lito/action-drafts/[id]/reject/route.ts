...
export async function POST(
  ...
  const log = createLogger({ request_id: requestId, route: 'POST /api/lito/action-drafts/[id]/reject' });
  ...
  try {
    ...
    if (error || !data) {
      log.error('lito_action_draft_reject_failed', {
    ...
    log.error('lito_action_draft_reject_unhandled', {
